  ...
  <input type="file" name="widgetToUpload" id="widgetToUpload" accept=".php,.zip">
   ...
   <p id="msg"></p>
    ...
    <tr>
        ...
        <td><a class="deleteWid" href="<?php echo plugins_url('actionScripts/cwdelete.php', dirname(__FILE__)) ; ?>?w=<?php echo$c['key']; ?>" title="delete <?php echo$c['name']; ?>">Delete Widget</a></td>
      <?php endif;?>
    </tr>
    <?php endforeach;?>
